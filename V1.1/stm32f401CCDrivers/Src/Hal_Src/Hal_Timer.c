...
static void vHAL_TIMX_CLK_EN(TIM_TypeDef *Inst);
static uint8_t HAL_TIMX_SIZE(TIM_TypeDef *Inst);
static uint32_t Get_TIM_Freq(TIM_TypeDef *Inst);

#if configHALTIMER_DELAY_EN == EN
static ERR xHAL_TIMXTB_Init(TIM_TypeDef *Inst ,TIMX_TimeBase_t *TIMX_init);
static void vHal_TIMXTimeBaseInt_EN(TIM_TypeDef *Inst,uint8_t Flag);
static void vHal_TIMXTimeBaseInt1_EN(TIM_TypeDef *Inst,uint8_t Flag,void(*TIMX_TIMEBASE)(void));
static ERR vHal_TIMXCNTEn(TIM_TypeDef *Inst ,uint8_t FLAG);
static void vHAL_Base1us(TIM_TypeDef *Inst);
static void vHAL_Base1ms(TIM_TypeDef *Inst);
static void vHal_CNT_Pin_Init(TIM_TypeDef *Inst);
#endif

#if configHALTIMX_ICP_EN == EN
static ERR vHALICP_Init(TIM_TypeDef *Inst ,TIMX_ICP_t *TIMX_init);
static void vHALICP_CallBack_Init(TIM_TypeDef *Inst ,TIMX_ICP_t *TIMX_init);
static void vHALICP_Pin_Init(TIM_TypeDef *Inst ,uint8_t CHN_No);
static void vHALICP_CHN_Init(TIM_TypeDef *Inst,uint8_t Prescaler,uint8_t CHN_No,uint8_t DigitalFilter,uint8_t EdgeSel);
static void vHalIcp_PreSet(__IO uint32_t *REG,uint8_t Prescaler ,uint8_t CHN_no);
static void vHALICP_EdgeSet(TIM_TypeDef *Inst,uint8_t Edge,uint8_t CCP,uint8_t CCNP);
static void vHALICP_FilterSet(__IO uint32_t *REG,uint8_t DigitalFilter,uint8_t Shift);
#endif

static ERR vHal_SetPrescaler(TIM_TypeDef *Inst ,uint8_t Flag);
/*-------------Static Variable Declaration----------------*/
#if configHALTIM1_INT_EN == EN
static void(*TIM1_TIMEBASE)(void) = NULL;
static void(*TIM1CH1_ICP)(void) = NULL;
static void(*TIM1CH2_ICP)(void) = NULL;
static void(*TIM1CH3_ICP)(void) = NULL;
static void(*TIM1CH4_ICP)(void) = NULL;
#endif
#if configHALTIM2_INT_EN == EN
static void(*TIM2_TIMEBASE)(void) = NULL;
static void(*TIM2CH1_ICP)(void) = NULL;
static void(*TIM2CH2_ICP)(void) = NULL;
static void(*TIM2CH3_ICP)(void) = NULL;
static void(*TIM2CH4_ICP)(void) = NULL;
#endif
#if configHALTIM3_INT_EN == EN
static void(*TIM3_TIMEBASE)(void) = NULL;
static void(*TIM3CH1_ICP)(void) = NULL;
static void(*TIM3CH2_ICP)(void) = NULL;
static void(*TIM3CH3_ICP)(void) = NULL;
static void(*TIM3CH4_ICP)(void) = NULL;
#endif
#if configHALTIM4_INT_EN == EN
static void(*TIM4_TIMEBASE)(void) = NULL;
static void(*TIM4CH1_ICP)(void) = NULL;
static void(*TIM4CH2_ICP)(void) = NULL;
static void(*TIM4CH3_ICP)(void) = NULL;
static void(*TIM4CH4_ICP)(void) = NULL;
#endif
#if configHALTIM5_INT_EN == EN
static void(*TIM5_TIMEBASE)(void) = NULL;
static void(*TIM5CH1_ICP)(void) = NULL;
static void(*TIM5CH2_ICP)(void) = NULL;
static void(*TIM5CH3_ICP)(void) = NULL;
static void(*TIM5CH4_ICP)(void) = NULL;
#endif
