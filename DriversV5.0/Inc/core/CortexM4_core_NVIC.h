...
typedef struct
{
	...
	__IO uint32_t RES_1[24];
	__IO uint32_t ISPR[8];
	__IO uint32_t RES_2[24];
	__IO uint32_t ICPR[24];
	__IO uint32_t RES_3[24];
	__IO uint32_t IABR[8];
	__IO uint32_t RES_4[56];
	__IO uint8_t  IPR[240];
	__IO uint32_t RES_5[644];
	__IO uint32_t STIR;
}NVIC_Typedef;
