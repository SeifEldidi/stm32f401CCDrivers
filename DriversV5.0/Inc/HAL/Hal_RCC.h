...
/*-------RCC_APB1ENR-----*/
#define HAL_RCC_TIM2_EN()   { if(!(READ_BIT(RCC->AHB1ENR,TIM2_RST))) {(SET_BIT(RCC->APB1ENR,TIM2_RST));}else{}}
#define HAL_RCC_TIM3_EN()   { if(!(READ_BIT(RCC->AHB1ENR,TIM3_RST))) {(SET_BIT(RCC->APB1ENR,TIM3_RST));}else{}}
#define HAL_RCC_TIM4_EN()   { if(!(READ_BIT(RCC->AHB1ENR,GPIOA_RST))) {(SET_BIT(RCC->APB1ENR,TIM4_RST));}else{}}
#define HAL_RCC_TIM5_EN()   { if(!(READ_BIT(RCC->AHB1ENR,TIM4_RST))) {(SET_BIT(RCC->APB1ENR,TIM5_RST));}else{}}
#define HAL_RCC_WWDG_EN()   { if(!(READ_BIT(RCC->AHB1ENR,WWDG_RST))) {(SET_BIT(RCC->APB1ENR,WWDG_RST));}else{}}
#define HAL_RCC_SPI2_EN()   { if(!(READ_BIT(RCC->AHB1ENR,SPI2_RST))) {(SET_BIT(RCC->APB1ENR,SPI2_RST));}else{}}
#define HAL_RCC_SPI3_EN()   { if(!(READ_BIT(RCC->AHB1ENR,SPI3_RST))) {(SET_BIT(RCC->APB1ENR,SPI3_RST));}else{}}
#define HAL_RCC_USART2_EN() { if(!(READ_BIT(RCC->AHB1ENR,USART2_RST))) {(SET_BIT(RCC->APB1ENR,USART2_RST));}else{}}
#define HAL_RCC_I2C1_EN()   { if(!(READ_BIT(RCC->AHB1ENR,I2C1_RST))) {(SET_BIT(RCC->APB1ENR,I2C1_RST));}else{}}
#define HAL_RCC_I2C2_EN()   { if(!(READ_BIT(RCC->AHB1ENR,I2C2_RST))) {(SET_BIT(RCC->APB1ENR,I2C2_RST));}else{}}
#define HAL_RCC_I2C3_EN()   { if(!(READ_BIT(RCC->AHB1ENR,I2C3_RST))) {(SET_BIT(RCC->APB1ENR,I2C3_RST));}else{}}
#define HAL_RCC_PWR_EN()    { if(!(READ_BIT(RCC->AHB1ENR,PWR_RST))) {(SET_BIT(RCC->APB1ENR,PWR_RST));}else{}}
/*-------RCC_APB2RENR-----*/
#define HAL_RCC_TIM1_EN()     { if(!(READ_BIT(RCC->AHB1ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,TIM1_RST));}else{}}
#define HAL_RCC_USART1_EN()   { if(!(READ_BIT(RCC->AHB1ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,USART1_RST));}else{}}
#define HAL_RCC_USART6_EN()   { if(!(READ_BIT(RCC->AHB1ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,USART6_RST));}else{}}
#define HAL_RCC_ADC1_EN()     { if(!(READ_BIT(RCC->AHB1ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,ADC1_RST));}else{}}
#define HAL_RCC_SDIO_EN()     { if(!(READ_BIT(RCC->AHB1ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,SDIO_RST));}else{}}
#define HAL_RCC_SPI1_EN()     { if(!(READ_BIT(RCC->AHB1ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,SPI1_RST));}else{}}
#define HAL_RCC_SPI4_EN()     { if(!(READ_BIT(RCC->AHB1ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,SPI4_RST));}else{}}
#define HAL_RCC_SYSCFG_EN()   { if(!(READ_BIT(RCC->AHB1ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,SYSCFG_RST));}else{}}
#define HAL_RCC_TIM9_EN()     { if(!(READ_BIT(RCC->AHB1ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,TIM9_RST));}else{}}
#define HAL_RCC_TIM10_EN()    { if(!(READ_BIT(RCC->AHB1ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,TIM10_RST));}else{}}
#define HAL_RCC_TIM11_EN()    { if(!(READ_BIT(RCC->AHB1ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,TIM11_RST));}else{}}
