...
/*-----------interrupts ----------*/
#define I2C1_INT_EN 				DIS
#define I2C2_INT_EN 				DIS
#define I2C3_INT_EN 				DIS
#define I2C_INT_EN					I2C1_INT_EN == EN || I2C2_INT_EN == EN || I2C3_INT_EN == EN
#if I2C1_INT_EN == EN && I2C2_INT_EN == DIS && I2C3_INT_EN == DIS \
	|| IC2_INT_EN == EN && IC1_INT_EN == DIS && IC3_INT_EN == DIS \
	|| IC3_INT_EN == EN && IC1_INT_EN == DIS && IC2_INT_EN == DIS
#define I2C_UPPERMULTIPLICITY		1
#elif I2C1_INT_EN == EN && I2C2_INT_EN == EN && I2C3_INT_EN == DIS \
	|| IC2_INT_EN == DIS && IC1_INT_EN == EN && IC3_INT_EN == EN \
	|| IC3_INT_EN == EN && IC1_INT_EN == DIS && IC2_INT_EN == EN
#define I2C_UPPERMULTIPLICITY		2
#elif I2C1_INT_EN == EN && I2C2_INT_EN == EN && I2C3_INT_EN == EN
#define I2C_UPPERMULTIPLICITY		3
#endif
...
#define I2C_BUSY_SET		0x01
#define	I2C_BUSY_IDLE		0x00

#define I2C1_SEL			0x00
#define I2C2_SEL			0x01
#define I2C3_SEL			0x02
...
ERR  xMCAL_I2C_MSTRIntSend(__IO  I2C_TypeDef * I2C , uint8_t SA,uint8_t *Data,uint8_t Data_Len);
ERR  xMCAL_I2C_MSTRIntRec(__IO  I2C_TypeDef * I2C , uint8_t SA,uint8_t Reg_ADD,uint8_t *Data,uint8_t Data_Len);
