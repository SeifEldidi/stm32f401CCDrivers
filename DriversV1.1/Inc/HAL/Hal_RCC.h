...
#define AHB_BASEPERIPH				0x40020000UL
#define RCC_BASE_ADDRESS_OFFSET		0x00003800UL
#define FLASH_UNIT_OFFSET			0x00003C00UL
#define RCC 						((volatile RCC_Typedef*)(AHB_BASEPERIPH+RCC_BASE_ADDRESS_OFFSET))
#define FLASH_ACR					*((volatile uint32_t *) (AHB_BASEPERIPH+FLASH_UNIT_OFFSET))
...
#define MCO1_CLK_PLL 			0U
#define MCO1_CLK_HSE 			1U
#define MCO1_CLK_HSI 			2U
#define MCO1_CLK_PLL2 			3U
/*------------RCC_CR-----------*/
...
#define MCO1PRE_5			(0b111<<MCO1PRE)
...
#define MCO1				21U
#define MCO1_HSI			(0x00<<MCO1)
#define MCO1_LSE			(0x01<<MCO1)
#define MCO1_HSE			(0x02<<MCO1)
#define MCO1_PLL			(0x03<<MCO1)
...
/*-------RCC_AHB1ENR-----*/
#define HAL_RCC_GPIOA_EN() { if(!(READ_BIT(RCC->AHB1ENR,GPIOA_RST))) {(SET_BIT(RCC->AHB1ENR,GPIOA_RST));}else{}}
#define HAL_RCC_GPIOB_EN() { if(!(READ_BIT(RCC->AHB1ENR,GPIOB_RST))) {(SET_BIT(RCC->AHB1ENR,GPIOB_RST));}else{}}
#define HAL_RCC_GPIOC_EN() { if(!(READ_BIT(RCC->AHB1ENR,GPIOC_RST))) {(SET_BIT(RCC->AHB1ENR,GPIOC_RST));}else{}}
#define HAL_RCC_GPIOD_EN() { if(!(READ_BIT(RCC->AHB1ENR,GPIOD_RST))) {(SET_BIT(RCC->AHB1ENR,GPIOD_RST));}else{}}
#define HAL_RCC_GPIOE_EN() { if(!(READ_BIT(RCC->AHB1ENR,GPIOE_RST))) {(SET_BIT(RCC->AHB1ENR,GPIOE_RST));}else{}}
#define HAL_RCC_GPIOH_EN() { if(!(READ_BIT(RCC->AHB1ENR,GPIOH_RST))) {(SET_BIT(RCC->AHB1ENR,GPIOH_RST));}else{}}
#define HAL_RCC_DMA1_EN()  { if(!(READ_BIT(RCC->AHB1ENR,DMA1_RST)))  {(SET_BIT(RCC->AHB1ENR,DMA1_RST));}else{}}
#define HAL_RCC_DMA2_EN()  { if(!(READ_BIT(RCC->AHB1ENR,DMA2_RST)))  {(SET_BIT(RCC->AHB1ENR,DMA2_RST));}else{}}
#define HAL_RCC_CRCR_EN()  { if(!(READ_BIT(RCC->AHB1ENR,DMA2_RST)))  {(SET_BIT(RCC->AHB1ENR,CRCR_RST));}else{}}

/*-------RCC_AHB2ENR-----*/
#define HAL_RCC_USBOTGFS_EN() (SET_BIT(RCC->AHB2ENR,USB_OTGFSRST));
/*-------RCC_APB1ENR-----*/
#define HAL_RCC_TIM2_EN()   { if(!(READ_BIT(RCC->APB1ENR,TIM2_RST))) {(SET_BIT(RCC->APB1ENR,TIM2_RST));}else{}}
#define HAL_RCC_TIM3_EN()   { if(!(READ_BIT(RCC->APB1ENR,TIM3_RST))) {(SET_BIT(RCC->APB1ENR,TIM3_RST));}else{}}
#define HAL_RCC_TIM4_EN()   { if(!(READ_BIT(RCC->APB1ENR,GPIOA_RST))) {(SET_BIT(RCC->APB1ENR,TIM4_RST));}else{}}
#define HAL_RCC_TIM5_EN()   { if(!(READ_BIT(RCC->APB1ENR,TIM4_RST))) {(SET_BIT(RCC->APB1ENR,TIM5_RST));}else{}}
#define HAL_RCC_WWDG_EN()   { if(!(READ_BIT(RCC->APB1ENR,WWDG_RST))) {(SET_BIT(RCC->APB1ENR,WWDG_RST));}else{}}
#define HAL_RCC_SPI2_EN()   { if(!(READ_BIT(RCC->APB1ENR,SPI2_RST))) {(SET_BIT(RCC->APB1ENR,SPI2_RST));}else{}}
#define HAL_RCC_SPI3_EN()   { if(!(READ_BIT(RCC->APB1ENR,SPI3_RST))) {(SET_BIT(RCC->APB1ENR,SPI3_RST));}else{}}
#define HAL_RCC_USART2_EN() { if(!(READ_BIT(RCC->APB1ENR,USART2_RST))) {(SET_BIT(RCC->APB1ENR,USART2_RST));}else{}}
#define HAL_RCC_I2C1_EN()   { if(!(READ_BIT(RCC->APB1ENR,I2C1_RST))) {(SET_BIT(RCC->APB1ENR,I2C1_RST));}else{}}
#define HAL_RCC_I2C2_EN()   { if(!(READ_BIT(RCC->APB1ENR,I2C2_RST))) {(SET_BIT(RCC->APB1ENR,I2C2_RST));}else{}}
#define HAL_RCC_I2C3_EN()   { if(!(READ_BIT(RCC->APB1ENR,I2C3_RST))) {(SET_BIT(RCC->APB1ENR,I2C3_RST));}else{}}
#define HAL_RCC_PWR_EN()    { if(!(READ_BIT(RCC->APB1ENR,PWR_RST))) {(SET_BIT(RCC->APB1ENR,PWR_RST));}else{}}
/*-------RCC_APB2RENR-----*/
#define HAL_RCC_TIM1_EN()     { if(!(READ_BIT(RCC->APB2ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,TIM1_RST));}else{}}
#define HAL_RCC_USART1_EN()   { if(!(READ_BIT(RCC->APB2ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,USART1_RST));}else{}}
#define HAL_RCC_USART6_EN()   { if(!(READ_BIT(RCC->APB2ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,USART6_RST));}else{}}
#define HAL_RCC_ADC1_EN()     { if(!(READ_BIT(RCC->APB2ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,ADC1_RST));}else{}}
#define HAL_RCC_SDIO_EN()     { if(!(READ_BIT(RCC->APB2ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,SDIO_RST));}else{}}
#define HAL_RCC_SPI1_EN()     { if(!(READ_BIT(RCC->APB2ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,SPI1_RST));}else{}}
#define HAL_RCC_SPI4_EN()     { if(!(READ_BIT(RCC->APB2ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,SPI4_RST));}else{}}
#define HAL_RCC_SYSCFG_EN()   { if(!(READ_BIT(RCC->APB2ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,SYSCFG_RST));}else{}}
#define HAL_RCC_TIM9_EN()     { if(!(READ_BIT(RCC->APB2ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,TIM9_RST));}else{}}
#define HAL_RCC_TIM10_EN()    { if(!(READ_BIT(RCC->APB2ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,TIM10_RST));}else{}}
#define HAL_RCC_TIM11_EN()    { if(!(READ_BIT(RCC->APB2ENR,TIM2_RST))) {(SET_BIT(RCC->APB2ENR,TIM11_RST));}else{}}
